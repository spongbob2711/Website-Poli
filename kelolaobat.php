<?php 
  ...
  $obat = query("SELECT id,nama_obat,kemasan,harga FROM obat ORDER BY id ASC;");
            ...
            <div class="card">
              <div class="card-header">
                ...
                <div class="card-tools ml-4 ">
                  <a href="tambahobat.php" class="btn btn-primary">Tambah Obat</a>
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $row["kemasan"]; ?></td>
                      <td><?= $row["harga"]; ?></td>
                      <td><a href="ubahobat.php?id=<?= $row["id"]; ?>" class="btn btn-warning">Edit</a><a href="hapusobat.php?id=<?= $row["id"]; ?>" class="btn btn-danger ml-2">Hapus</a></td>
                    </tr>
                   <?php endforeach; ?>
                  </tbody>
                </table>
