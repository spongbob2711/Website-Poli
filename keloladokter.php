<?php 
  ...
  $dokter = query("SELECT dokter.id, dokter.nama, dokter.no_hp, dokter.alamat, poli.nama_poli FROM dokter JOIN poli ON dokter.id_poli = poli.id ORDER BY dokter.id ASC;");
                ...
                <table class="table table-hover text-nowrap">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td><?= $row["alamat"]; ?></td>
                      <td><?= $row["nama_poli"]; ?></td>
                      <td><a href="ubahdokter.php?id=<?= $row["id"]; ?>" class="btn btn-warning">Edit</a><a href="hapusdokter.php?id=<?= $row["id"]; ?>" class="btn btn-danger ml-2">Hapus</a></td>
                    </tr>
                   <?php endforeach; ?>
                  </tbody>
                </table>
