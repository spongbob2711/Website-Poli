<?php 
  ...
  $dokter = query("SELECT COUNT(*) AS total_doctors FROM dokter")[0];
  $pasien = query("SELECT COUNT(*) AS total_patients FROM pasien")[0];
  $obat = query("SELECT COUNT(*) AS total_obat FROM obat")[0];
  $poli = query("SELECT COUNT(*) AS total_poli FROM poli")[0];
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-info"><i class="far fa-user" style="color: #ffffff;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Poli</span>
                <span class="info-box-number"><?= $poli["total_poli"]?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-success"><i class="far fa-user" style="color: #ffffff;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Dokter</span>
                <span class="info-box-number"><?= $dokter["total_doctors"]?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-warning"><i class="far fa-user" style="color: #ffffff;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Pasien</span>
                <span class="info-box-number"><?= $pasien["total_patients"]?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box">
              <span class="info-box-icon bg-danger"><i class="far fa-user" style="color: #ffffff;"></i></span>

              <div class="info-box-content">
                <span class="info-box-text">Obat</span>
                <span class="info-box-number"><?= $obat["total_obat"]?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
